...
export const convertLink = linkImported => dispatch => {
  ...
  axios
    .post("/api/links/converter", linkImported)
    .then(res =>
      dispatch({
        type: CONVERT_LINK,
        payload: res.data
...
export const redirectLink = linkcode => dispatch => {
  axios
    .get(`/api/links/redirect/${linkcode}`)
    .then(res =>
      dispatch({
        type: REDIRECT_LINK,
        payload: res.data
...
export const addLink = linkComming => dispatch => {
  axios
    .post("/api/links/savelink", linkComming)
    .then(res => {
...
export const addComment = (linkId, commentData) => dispatch => {
  ...
  axios
    .post(`/api/links/comments/${linkId}`, commentData)
...
export const deleteComment = (id, comment_id) => dispatch => {
  ...
  axios
    .delete(`/api/links/comments/${id}/${comment_id}`)
...
export const addLikeToComment = (id, comment_id) => dispatch => {
  axios
    .post(`/api/links/comments/like/${id}/${comment_id}`)
    .then(res => dispatch(getLink(id)))
    .catch(err =>
      dispatch({
        type: GET_ERRORS,
...
export const deleteLikeFromComment = (id, comment_id) => dispatch => {
  axios
    .delete(`/api/links/comments/unlike/${id}/${comment_id}`)
    .then(res => dispatch(getLink(id)))
    .catch(err =>
      dispatch({
        type: GET_ERRORS,
