...
class InputGroup extends Component {
  constructor ({ name, value, placeholder, label, error, info, type, onChange, disabled, icon, className}) {
    super();
    this.state = {
    name, value, placeholder, label, error, info, type, onChange, disabled, icon, className};
  }
      ...
      <div className=''>
        <div className='input-group'>
          <div className='input-group-prepend'>
            <span className='input-group-icon'><i className={this.props.icon}></i></span>
          </div>
          <input
